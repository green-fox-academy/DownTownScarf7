...
const car = {
  ...
  refill: function (amount) {
    const beforeLevel = this.petrolLevel;
    this.petrolLevel += this.petrolCapacity - this.petrolLevel < amount ? 50 : amount;
    return amount - (this.petrolCapacity - beforeLevel);
  }
}
...
const station = {
  ...
  provide: function (vehicle) {
    this.petrolStorage = vehicle.refill(this.petrolStorage);
  }
}
